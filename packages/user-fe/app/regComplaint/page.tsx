...
export default function RegisterComplaintPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-linear-to-b from-slate-50 via-white to-slate-100">
      ...
      <div className="relative z-10 py-8 sm:py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <motion.div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-orange-100 to-amber-100 text-orange-700 text-sm font-medium mb-4"
