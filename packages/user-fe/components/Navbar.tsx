            ...
            {isLoggedIn ? (
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className='flex items-center gap-2 px-3 py-2 rounded-full bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium hover:opacity-90 transition-all shadow-md hover:shadow-lg'
                >
